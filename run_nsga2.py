...
class RunNSGA2:
    ...
    def __init__(self,  
                ...
                scoring_fn: Callable,
                emitter: Emitter,
                moqd_metrics_fn: Callable,
                ga_metrics_fn: Callable,
        ...
        self.ga_metrics_fn = ga_metrics_fn
    ...
    def run(self,
        ...
        nsga2 = NSGA2(
            ...
            ga_metrics_function=self.ga_metrics_fn,
        )
        ...
        repertoire, moqd_passive_repertoire, emitter_state, init_metrics, random_key = nsga2.init(
            init_genotypes,
        ...
        nsga2_scan_fn = nsga2.scan_update
