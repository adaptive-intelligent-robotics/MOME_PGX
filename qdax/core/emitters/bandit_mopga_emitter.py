...
from qdax.core.emitters.dynamic_bandit_mopga_emitter import DynamicBanditMultiEmitter
...
@dataclass
class DynamicBanditMOPGAConfig:
    """Configuration for PGAME Algorithm"""
...
class DynamicBanditMOPGAEmitter(DynamicBanditMultiEmitter):
    def __init__(
        self,
        config: DynamicBanditMOPGAConfig,
        policy_network: nn.Module,
        env: QDEnv,
        variation_fn: Callable[[Params, Params, RNGKey], Tuple[Params, RNGKey]],
    ) -> None:
...
class DynamicBanditManyEmitters(DynamicBanditMultiEmitter):
    def __init__(
        self,
        config: DynamicBanditMOPGAConfig,
        policy_network: nn.Module,
